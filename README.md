...
> [!NOTE]
> As the back-end is hosted as a free Render instance, it takes some time for it to "wake up" after being inactive for a while. This can cause noticeable loading times, especially when logging in or signing up.
> 
