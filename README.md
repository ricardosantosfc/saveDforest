...
> [!NOTE]
> As the back-end server is hosted as a free [Render](https://render.com/) instance, it takes some time to restart after long periods of inactivity. This can cause noticeable loading times, especially when logging in or signing up.
> 
